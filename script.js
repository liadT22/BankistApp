...
const account1 = {
  ...
  movementsDates: [
    ...
    '2022-06-27T23:36:17.929Z',
    '2022-06-29T10:51:36.790Z',
  ],
  currency: 'NIS',
  locale: 'he-IL', // de-DE
};
...
const calcDisplaySummary = function (acc) {
  ...
  labelSumIn.textContent = formatCur(incomes, acc.loacle, acc.currency);
  ...
  labelSumInterest.textContent = formatCur(interest, acc.loacle, acc.currency);
};
